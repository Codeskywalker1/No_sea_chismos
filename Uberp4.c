...
void consumidor(void* ptr) {
   ...
   while(true){
      ...
      if (viaje.tipoUber==UBERBLACK){
         gL = (TARIFA_UBER_BLACK*(viaje.tiempo));
      }else{
         gL = (TARIFA_UBER_X*(viaje.tiempo));
      }
